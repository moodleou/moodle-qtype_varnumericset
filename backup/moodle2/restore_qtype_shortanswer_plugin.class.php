...
class restore_qtype_varnumeric_plugin extends restore_qtype_plugin {
    ...
    protected function define_question_plugin_structure() {
        ...
        $elepath = $this->get_pathfor('/varnumeric');
     ...
     */
    public function process_varnumeric($data) {
        global $DB;
        ...
        if ($questioncreated) {
            ...
            // Insert record
            $newitemid = $DB->insert_record('question_varnumeric', $data);
            // Create mapping
            $this->set_mapping('question_varnumeric', $oldid, $newitemid);
        }
    }
}
