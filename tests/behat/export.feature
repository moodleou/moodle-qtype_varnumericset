...
Feature: Test exporting Variable numeric set questions
  As a teacher
  In order to be able to reuse my Variable numeric set questions
  ...
  Scenario: Export a Variable numeric set question
